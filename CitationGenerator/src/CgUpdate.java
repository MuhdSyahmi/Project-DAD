...
public class CgUpdate extends JFrame {
	...
	public CgUpdate() {
		...
		lblWebsiteUrl.setBounds(20, 117, 107, 14);
		...
		lblWebsiteArticleTitle.setBounds(20, 148, 124, 14);
			...
			public void actionPerformed(ActionEvent e) {
				...
				{	
					public void run()
					{
						...
						params.add(new BasicNameValuePair("selectFn", "updateWebsite"));
		...
		btnSave.setBounds(151, 211, 256, 23);
		contentPane.add(btnSave);
		
		lblUpdateYourWebsite = new JLabel("Update your website detail:");
		lblUpdateYourWebsite.setForeground(new Color(255, 255, 255));
		lblUpdateYourWebsite.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblUpdateYourWebsite.setBounds(20, 87, 198, 14);
		...
		textField_searchurl.setBounds(20, 40, 278, 20);
		...
		btnSearch.setBounds(315, 39, 89, 23);
		...
		btnClose.setBounds(307, 262, 97, 25);
